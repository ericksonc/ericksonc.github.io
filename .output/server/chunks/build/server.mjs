...
const _routes = [
  {
    name: "about-us",
    path: "/about-us",
    component: () => import('./about-us.vue.mjs')
  },
  {
    name: "contact-us",
    path: "/contact-us",
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(_attrs)}><button class="menu-toggle fixed top-5 left-5 z-[1001] bg-transparent border-none flex flex-col justify-between w-8 h-5"><span class="block h-[3px] w-full bg-textPrimary transition-all duration-300"></span><span class="block h-[3px] w-full bg-textPrimary transition-all duration-300"></span><span class="block h-[3px] w-full bg-textPrimary transition-all duration-300"></span></button><nav class="${ssrRenderClass([{ "translate-x-0": unref(menuOpen) }, "menu fixed top-0 left-0 w-64 h-screen bg-black/50 backdrop-blur-sm z-[999] transform -translate-x-full transition-transform duration-300 shadow-md"])}"><ul class="pt-16 pb-5 px-5"><li class="mb-4">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        onClick: closeMenu,
        class: "text-white no-underline font-sans text-lg hover:text-accentOmnicaBlue"
      }, {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer py-5 px-5 text-center bg-white text-gray-800" }, _attrs))}><p class="font-sans text-sm">© Omnica 2025</p></footer>`);
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "overflow-hidden border-0 outline-none" }, _attrs))}>`);
